...
> Deep navy with luxurious gold accents and cream backgrounds

## 🎨 Theme Overview

This design system was generated for the **Luxury** aesthetic. It includes a complete set of components, colors, and typography tailored to this style.
...
| Color | Hex | Usage |
|-------|-----|-------|
| Primary | #1a1a2e | Main brand color, CTAs |
| Secondary | #4a4e69 | Supporting elements |
| Accent | #c9a227 | Highlights, links |
| Background | #faf8f5 | Page background |
| Surface | #f5f0e8 | Card backgrounds |
| Text | #0f0f1a | Body text |
| Border | #d4cfc0 | Dividers, outlines |

## ✏️ Typography

### Font Families

- **Headings:** 'Cormorant', 600, 400, 300
