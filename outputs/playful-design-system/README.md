...
> Vibrant purple and pink with sunny yellow accents

## 🎨 Theme Overview

This design system was generated for the **Playful** aesthetic. It includes a complete set of components, colors, and typography tailored to this style.
...
| Secondary | #f472b6 | Supporting elements |
| Accent | #fbbf24 | Highlights, links |
| Background | #fefce8 | Page background |
| Surface | #fef3c7 | Card backgrounds |
| Text | #1f2937 | Body text |
| Border | #fde68a | Dividers, outlines |
